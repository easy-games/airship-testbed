...
interface IInputStateCallbackReceiver {
    ...
    GetStateOffsetForEvent(control: InputControl, eventPtr: InputEventPtr, offset: unknown): boolean;
    OnNextUpdate(): void;
...
interface InputDevice extends InputControl {
    ...
    allControls: CSArray<InputControl>;
    valueType: unknown;
    ...
    ExecuteCommand<TCommand>(command: unknown): number;
    MakeCurrent(): void;
...
interface InputDeviceDescription {
    ...
    Equals(other: InputDeviceDescription): boolean;
    Equals(obj: unknown): boolean;
    GetHashCode(): number;
    ToJson(): string;
    ToString(): string;
...
interface InputDeviceDescriptionConstructor {


    FromJson(json: string): InputDeviceDescription;
}
declare const InputDeviceDescription: InputDeviceDescriptionConstructor;
...
interface FourCC {
    ...
    constructor(code: number): FourCC;
    constructor(a: string, b: string, c: string, d: string): FourCC;
    constructor(str: string): FourCC;

    Equals(other: FourCC): boolean;
    Equals(obj: unknown): boolean;
    GetHashCode(): number;
    ToString(): string;
}
    
interface FourCCConstructor {


    FromInt32(i: number): FourCC;
    ToInt32(fourCC: FourCC): number;
}
declare const FourCC: FourCCConstructor;
    
interface InputDeviceConstructor {
    InvalidDeviceId: number;
    all: CSArray<InputDevice>;


}
declare const InputDevice: InputDeviceConstructor;
    
interface InternedString {
    length: number;

    constructor(text: string): InternedString;

    CompareTo(other: InternedString): number;
    Equals(obj: unknown): boolean;
    Equals(other: InternedString): boolean;
    GetHashCode(): number;
    IsEmpty(): boolean;
    ToLower(): string;
    ToString(): string;
...
interface InputStateBlock {
    ...
    CopyToFrom(toStatePtr: unknown, fromStatePtr: unknown): void;
    ReadDouble(statePtr: unknown): number;
    ReadFloat(statePtr: unknown): number;
    ReadInt(statePtr: unknown): number;
    Write(statePtr: unknown, value: PrimitiveValue): void;
    WriteDouble(statePtr: unknown, value: number): void;
    WriteFloat(statePtr: unknown, value: number): void;
    WriteInt(statePtr: unknown, value: number): void;
}
...
interface PrimitiveValue {
    ...
    constructor(value: boolean): PrimitiveValue;
    constructor(value: string): PrimitiveValue;
    constructor(value: number): PrimitiveValue;
    constructor(value: number): PrimitiveValue;
    constructor(value: number): PrimitiveValue;
    constructor(value: number): PrimitiveValue;
    constructor(value: number): PrimitiveValue;
    ...
    Equals(other: PrimitiveValue): boolean;
    Equals(obj: unknown): boolean;
    GetHashCode(): number;
    GetTypeCode(): TypeCode;
    ToBoolean(provider: unknown): boolean;
    ToByte(provider: unknown): number;
    ToChar(provider: unknown): string;
    ToDateTime(provider: unknown): string;
    ToDecimal(provider: unknown): number;
    ToDouble(provider: unknown): number;
    ToInt16(provider: unknown): number;
    ToInt32(provider: unknown): number;
    ToInt64(provider: unknown): number;
    ToObject(): unknown;
    ToSByte(provider: unknown): number;
    ToSingle(provider: unknown): number;
    ToString(): string;
    ToString(provider: unknown): string;
    ToType(conversionType: unknown, provider: unknown): unknown;
    ToUInt16(provider: unknown): number;
    ToUInt32(provider: unknown): number;
    ToUInt64(provider: unknown): number;
}
    
interface PrimitiveValueConstructor {


    From<TValue>(value: TValue): PrimitiveValue;
    FromBoolean(value: boolean): PrimitiveValue;
    FromByte(value: number): PrimitiveValue;
    FromChar(value: string): PrimitiveValue;
    FromDouble(value: number): PrimitiveValue;
    FromInt16(value: number): PrimitiveValue;
    FromInt32(value: number): PrimitiveValue;
    FromInt64(value: number): PrimitiveValue;
    FromObject(value: unknown): PrimitiveValue;
    FromSByte(value: number): PrimitiveValue;
    FromSingle(value: number): PrimitiveValue;
    FromString(value: string): PrimitiveValue;
    FromUInt16(value: number): PrimitiveValue;
    FromUInt32(value: number): PrimitiveValue;
    FromUInt64(value: number): PrimitiveValue;
}
declare const PrimitiveValue: PrimitiveValueConstructor;
...
interface InputStateBlockConstructor {
    ...
    FormatFloat: FourCC;
    FormatDouble: FourCC;
    FormatVector2: FourCC;
    FormatVector3: FourCC;
    FormatQuaternion: FourCC;
    FormatVector2Short: FourCC;
    ...
    GetSizeOfPrimitiveFormatInBits(type: FourCC): number;
}
declare const InputStateBlock: InputStateBlockConstructor;
...
interface InputEventPtr {
    ...
    constructor(eventPtr: InputEvent): InputEventPtr;

    Equals(other: InputEventPtr): boolean;
    Equals(obj: unknown): boolean;
    GetHashCode(): number;
    IsA<TOtherEvent>(): boolean;
    Next(): InputEventPtr;
...
interface InputEventPtrConstructor {


    From(eventPtr: InputEvent): InputEventPtr;
    FromInputEventPtr(eventPtr: InputEventPtr): InputEvent;
}
declare const InputEventPtr: InputEventPtrConstructor;
    
interface Pointer extends InputDevice, IInputStateCallbackReceiver {
    position: Vector2Control;
    delta: DeltaControl;
...
interface DeltaControl extends Vector2Control {
    up: AxisControl;
    down: AxisControl;
    left: AxisControl;
    right: AxisControl;

    constructor(): DeltaControl;

}
    
interface ButtonControl extends AxisControl {
    pressPoint: number;
...
interface Mouse extends Pointer {
    scroll: DeltaControl;
    leftButton: ButtonControl;
    middleButton: ButtonControl;
    rightButton: ButtonControl;
    backButton: ButtonControl;
    forwardButton: ButtonControl;
    clickCount: IntegerControl;
...
interface AccessoryBuilder extends MonoBehaviour {
    ...
    SetAccessoryKit(kit: AccessoryKit): void;
}
...
interface SavePointlight {
    ...
    constructor(color: Color, position: Vector3, rotation: Quaternion, intensity: number, range: number, castShadows: boolean, highQualityLight: boolean): SavePointlight;
