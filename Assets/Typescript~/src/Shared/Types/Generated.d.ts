...
interface DynamicVariables extends NetworkBehaviour {
    strings: CSDictionary<string, string>;
    numbers: CSDictionary<string, number>;
    vectors: CSDictionary<string, Vector3>;
    key: string;
