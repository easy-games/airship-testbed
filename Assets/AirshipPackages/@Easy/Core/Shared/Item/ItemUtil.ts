...
export class ItemUtil {
	public static readonly defaultItemPath = "AirshipPackages/@Easy/Core/Prefabs/Accessories/missing_item.prefab";
	...
	public static RegisterItem(
		...
		if (itemMeta.accessoryPaths) {
			...
			accessoryPaths = ["AirshipPackages/@Easy/Core/Accessories/block.prefab"];
		}
