...
interface Promise<T> {
	 ...
	 */
		...
		this: Promise<T>,
		doneHandler: (status: Promise.Status) => TResult
	): Promise<TResult>;
	 ...
	 */
	doneCall<P extends Array<any>, R>(
		this: Promise<T>,
		callback: (...args: P) => R,
		...args: P
	): Promise<R>;
...
interface PromiseConstructor {
	 ...
	 */
	promisify: <T extends Array<any>, U>(
		callback: (...args: T) => U
	) => (...args: T) => Promise<U>;
