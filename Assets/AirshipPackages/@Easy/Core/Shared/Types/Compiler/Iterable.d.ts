...
type IteratorResult<Yields, Returns = void> =
	| IteratorYieldResult<Yields>
	| IteratorReturnResult<Returns>;
...
interface Generator<Yields = unknown, Returns = void, Next = unknown>
	extends Iterator<Yields, Returns, Next> {
	next: (...args: [] | [Next]) => IteratorResult<Yields, Returns>;
	[Symbol.iterator](): Generator<Yields, Returns, Next>;
}

interface AsyncGenerator<Yields = unknown, Returns = any, Next = unknown>
	extends AsyncIterator<Yields, Returns, Next> {
	next: (...args: [] | [Next]) => Promise<IteratorResult<Yields, Returns>>;
