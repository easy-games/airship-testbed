...
export default class FriendCard extends AirshipBehaviour {
    ...
    public Awake(): void {
        ...
        CanvasAPI.OnBeginDragEvent(this.gameObject, (data) => {
            cloneObject = Object.Instantiate(this.gameObject, this.transform.parent!.parent!.parent?.parent?.parent!);
            ...
            cloneRect.sizeDelta = new Vector2(this.rectTransform.rect.width, cloneRect!.rect.height = this.rectTransform.rect.height);
