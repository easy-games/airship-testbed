...
export namespace GameCoordinatorUsers {
    ...
    export type SearchUserArgs = {
        query?: GameCoordinatorUsers.SearchUser;
    };
    ...
    export interface ClientSpec {
        ...
        searchUser(
            args?: SearchUserArgs["query"],
            options?: RequestOptions,
        ): Promise<{ users: GameCoordinatorUsers.PublicUser[] }>;
        update(
    ...
    export class Client implements ClientSpec {
        ...
        async searchUser(
            ...
            return await this.makeRequest({
                method: "GET",
                routeId: "GameCoordinator:Users:searchUser",
                path: `/users/search`,
                retryKey: options?.retryKey ?? "GameCoordinator:Users:searchUser",
                query: args,
            });
        }
        async update(
