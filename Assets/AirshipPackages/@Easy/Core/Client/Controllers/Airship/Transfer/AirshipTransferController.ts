import {
	BridgeApiTransferToGame,
	BridgeApiTransferToPartyLeader,
	TransferControllerBridgeTopics,
} from "@Easy/Core/Client/ProtectedControllers/Airship/Transfer/TransferController";
...
export class TransferController implements OnStart {
	...
	public async TransferToGameAsync(
		...
		return await AirshipUtil.PromisifyBridgeInvoke<BridgeApiTransferToGame>(
	...
	public async TransferToPartyLeader(): Promise<Result<undefined, undefined>> {
		return await AirshipUtil.PromisifyBridgeInvoke<BridgeApiTransferToPartyLeader>(
