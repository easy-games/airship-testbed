Shader "Airship/WorldShaderPBR"
{
    Properties
    {
        ...
        _EmissiveLevel("Emissive Level (extra)", range(0,3)) = 0.0
        ...
        _RimIntensity("Rim Intensity (extra)", Range(0, 5)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            HLSLPROGRAM
                #pragma target 3.5
                #include "Assets/AirshipPackages/@Easy/CoreMaterials/BaseShaders/AirshipSimpleShadowPass.hlsl"
            ENDHLSL
        }
