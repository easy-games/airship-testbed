...
export const CoreNetwork = {
	...
	ServerToClient: {
		...
		BlockHit: new RemoteEvent<[blockPos: Vector3, blockId: number, entityId: number]>(),
		BlockGroupHit: new RemoteEvent<[blockPositions: Vector3[], blockIds: number[], entityId: number]>(),
