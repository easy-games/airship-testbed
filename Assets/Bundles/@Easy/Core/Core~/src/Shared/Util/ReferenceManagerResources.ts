...
export enum AllBundleItems {
	...
	Entity_OnHit_FlinchAnimFPS = "@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/OnHit/Armature_FPS_Flinch.anim",
	Entity_OnHit_DeathAnimFPS = "@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/OnHit/Armature_FPS_Death.anim",
	Entity_OnHit_FlinchAnimTP = "@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/OnHit/Armature_TP_Flinch.anim",
	Entity_OnHit_DeathAnimTP = "@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/OnHit/Armature_TP_Death.anim",
	...
	ItemUnarmed_FirstPerson_Idle = "@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/FPS_HIdden.anim",
	ItemUnarmed_FirstPerson_Equip = "@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/FPS_HIdden.anim",
	ItemUnarmed_FirstPerson_UnEquip = "@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/FPS_HIdden.anim",
	ItemUnarmed_FirstPerson_Use01 = "@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/FPS_HIdden.anim",
				...
				Bundle_Blocks.VFX,
				{
					...
					filePaths: new Map([
						[
							...
							"@Easy/Core/Shared/Resources/Prefabs/VFX/Blocks/OnBlockHitVFX.prefab",
						],
						[
							Bundle_Blocks_VFX.OnDeath,
							"@Easy/Core/Shared/Resources/Prefabs/VFX/Blocks/OnBlockDeathVFX.prefab",
						],
						[
							Bundle_Blocks_VFX.OnHitFire,
							"@Easy/Core/Shared/Resources/Prefabs/VFX/Blocks/OnBlockHitFireVFX.prefab",
						],
					]),
				},
			],
				...
				Bundle_Entity.OnHit,
				{
					...
					filePaths: new Map([
						[
							...
							"@Easy/Core/Shared/Resources/Prefabs/VFX/Entity/OnHit/EntityOnHitVFX.prefab",
						],
						[
							Bundle_Entity_OnHit.DeathVFX,
							"@Easy/Core/Shared/Resources/Prefabs/VFX/Entity/OnHit/EntityOnDeathVFX.prefab",
						],
						[
							Bundle_Entity_OnHit.DeathVoidVFX,
							"@Easy/Core/Shared/Resources/Prefabs/VFX/Entity/OnHit/EntityOnDeathVoidVFX.prefab",
						],
						[
							Bundle_Entity_OnHit.FlinchAnimFPS,
							"@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/OnHit/Armature_FPS_Flinch.anim",
						],
						[
							Bundle_Entity_OnHit.DeathAnimFPS,
							"@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/OnHit/Armature_FPS_Death.anim",
						],
						[
							Bundle_Entity_OnHit.FlinchAnimTP,
							"@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/OnHit/Armature_TP_Flinch.anim",
						],
						[
							Bundle_Entity_OnHit.DeathAnimTP,
							"@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/OnHit/Armature_TP_Death.anim",
						],
					]),
				},
			],
				...
				Bundle_Entity.Movement,
				{
					...
					filePaths: new Map([
						[
							...
							"@Easy/Core/Shared/Resources/Prefabs/VFX/Entity/Movement/SprintVFX.prefab",
						],
						[
							Bundle_Entity_Movement.LandVFX,
							"@Easy/Core/Shared/Resources/Prefabs/VFX/Entity/Movement/LandingVFX.prefab",
						],
						...
						[
							...
							"@Easy/Core/Shared/Resources/Sound/Movement/s_Movement_Slide_Start_01.wav",
						],
						[
							Bundle_Entity_Movement.SlideSFX1,
							"@Easy/Core/Shared/Resources/Sound/Movement/s_Movement_Slide_Start_02.wav",
						],
						[
							Bundle_Entity_Movement.SlideSFX2,
							"@Easy/Core/Shared/Resources/Sound/Movement/s_Movement_Slide_Start_03.wav",
						],
						[
							Bundle_Entity_Movement.SlideSFX3,
							"@Easy/Core/Shared/Resources/Sound/Movement/s_Movement_Slide_Start_04.wav",
						],
						[
							Bundle_Entity_Movement.SlideSFXLoop,
							"@Easy/Core/Shared/Resources/Sound/Movement/s_Movement_Slide_Loop.wav",
						],
					]),
				},
			],
				...
				Bundle_ItemBlock.FirstPerson,
				{
					...
					filePaths: new Map([
						[
							...
							"@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/FP_Sword_Idle.anim",
						],
				...
				Bundle_ItemPickaxe.Prefabs,
				{
					...
					filePaths: new Map([
						[
							...
							"@Easy/Core/Shared/Resources/Prefabs/VFX/Items/Sword/SwordSwingFX.prefab",
						],
						[
							Bundle_ItemPickaxe_Prefabs.OnHit,
							"@Easy/Core/Shared/Resources/Prefabs/VFX/Items/Sword/SwordHitFX.prefab",
						],
					]),
				},
			],
		...
		bundles: new Map([
			[
				Bundle_ItemSword.FirstPerson,
				{
					...
					filePaths: new Map([
						...
						[
							Bundle_ItemSword_FirstPerson.UnEquip,
							"@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/FP_Sword_Idle.anim",
						],
						[
							Bundle_ItemSword_FirstPerson.Use01,
							"@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/FP_Sword_Use.anim",
						],
					]),
				},
			...
			[
				Bundle_ItemSword.ThirdPerson,
				{
					...
					filePaths: new Map([
						...
						[
							Bundle_ItemSword_ThirdPerson.Use,
							"@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/FP_Sword_Use.anim",
						],
					]),
				},
			...
			[
				Bundle_ItemSword.Prefabs,
				{
					...
					filePaths: new Map([
						[
							Bundle_ItemSword_Prefabs.OnUse,
							"@Easy/Core/Shared/Resources/Prefabs/VFX/Items/Sword/SwordSwingFX.prefab",
						],
						[
				...
				Bundle_ItemUnarmed.FirstPerson,
				{
					...
					filePaths: new Map([
						[
							...
							"@Easy/Core/Shared/Resources/Entity/HumanEntity/HumanAnimations/Root/FPS_HIdden.anim",
						],
						[
				...
				Bundle_ItemUnarmed.SFX,
				{
					...
					filePaths: new Map([
						[
							...
							"@Easy/Core/Shared/Resources/Sound/Items/Equip/Equip_Generic.ogg",
						],
					]),
				},
			],
				...
				Bundle_Projectiles.OnHitVFX,
				{
					...
					filePaths: new Map([
						[
							...
							"@Easy/Core/Shared/Resources/Prefabs/VFX/Projectiles/OnArrowHitVfx.prefab",
						],
						[
