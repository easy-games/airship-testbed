...
export declare class DataStore implements OnStart {
     ...
     */
    GetDataKey<T extends object>(key: string): Promise<Result<T, undefined>>;
    /**
     ...
     */
    SetDataKey<T extends object>(key: string, data: T): Promise<Result<T, undefined>>;
    /**
     ...
     */
    DeleteDataKey<T extends object>(key: string): Promise<Result<T | undefined, undefined>>;
    /**
