...
export declare const CoreNetwork: {
    ClientToServer: {
        ...
        SetHeldItemState: RemoteEvent<[heldItemState: HeldItemState, lookVector: Vector3]>;
    ...
    ServerToClient: {
        ...
        SetHeldInventorySlot: RemoteEvent<[invId: number | undefined, clientId: number | undefined, slot: number, clientPredicted: boolean]>;
        ...
        HeldItemStateChanged: RemoteEvent<[characterId: number, state: HeldItemState, lookVector: Vector3]>;
