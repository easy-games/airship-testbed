...
import { RetryConfig, RetryHttp429 } from "@Easy/Core/Shared/Http/HttpRetry";
...
export default class RateLimitingButton extends AirshipBehaviour {
    ...
    private async CallNonRateLimited(): Promise<void> {
        ...
        await RetryHttp429(NonRateLimited, RateLimitConfig);
    ...
    private async CallRateLimited5Seconds(): Promise<void> {
        ...
        await RetryHttp429(RateLimitedXSeconds(5), RateLimitConfig);
    ...
    private async CallRateLimited10Seconds(): Promise<void> {
        ...
        await RetryHttp429(RateLimitedXSeconds(10), RateLimitConfig);
    ...
    private async CallRateLimited30Seconds(): Promise<void> {
        ...
        await RetryHttp429(RateLimitedXSeconds(30), RateLimitConfig);
