...
import { TopDownBattleRangedItem } from "./TopDownItems/TopDownRangedItem";
...
ItemUtil.RegisterItem("Weapon01", {
  ...
  maxStackSize: 1,
  accessoryPaths: [
    "Shared/Resources/Demo/TopDownBattle/Accessories/HeldItems/TopDownBattle_Weapon01.prefab",
  ],
